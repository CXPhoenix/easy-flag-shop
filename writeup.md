...
- **題目描述**: 這是一個販賣各種駭客用品的網站，網站的製作者聲稱：除非你當台幣戰士，否則你不可能買得到 flag 的！
...
| 前端數量輸入框不允許輸入負數，顯示「❌ 輸入錯誤：數量不能為小數！」 | 懷疑後端驗證也一樣嚴格，準備轉向找 SQLi / XSS | 做了其他嘗試沒有其他結果，但意識到這只是前端防護，核心邏輯未必有同樣的驗證 |
